...
object SparkLRhdfs2 {
  ...
  println(args.reduce(_+" "+_))
    ...
    val sc = new SparkContext("spark://" + Source.fromFile("/root/spark-ec2/masters").mkString.trim  + ":7077", "SparkLRhdfs2", "/root/spark/", List("target/scala-2.9.2/spark-tutorial_2.9.2-0.1.jar"))
